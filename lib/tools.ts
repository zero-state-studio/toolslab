...
export const tools: Tool[] = [
  ...
  // Social Media Tools
  {
    ...
    longTailKeywords: [
      ...
      'whatsapp qr code generator for business',
      'generate whatsapp link with pre filled message',
      'whatsapp chat link generator no signup',
      'create whatsapp button for website free',
      'wa.me link generator with country code',
      'whatsapp link for business card qr code',
      'how to make whatsapp link for website',
      'whatsapp message link generator with templates',
