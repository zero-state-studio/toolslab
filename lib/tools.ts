...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    longTailKeywords: [
      ...
      'decode base64 to gif file',
      'base64 animated gif decoder online',
      'how to convert base64 to gif',
      'base64 encoded gif to image download',
      'save base64 as gif file',
      'base64 data uri to gif converter',
      'online base64 to gif converter no upload',
      'convert base64 to animated gif free',
      'base64 to gif without server',
      'browser base64 to gif decoder',
    ],
    searchVolume: 2800,
    label: '',
  },
  {
    ...
    longTailKeywords: [
      ...
      'base64 png decoder online',
      'how to convert base64 to png',
      'base64 encoded image to png download',
      'save base64 as png file',
      'base64 data uri to png converter',
      'online base64 to png converter no upload',
      'convert base64 to png with transparency',
      'base64 to png without server',
      'browser base64 to png decoder',
    ],
    searchVolume: 3500,
    label: '',
  },
  {
    ...
    longTailKeywords: [
      ...
      'base64 encoded image to jpeg download',
      'save base64 as jpg file',
      'base64 data uri to jpg converter',
      'online base64 to jpeg converter no upload',
      'convert base64 to image file free',
      'base64 to jpg without server',
      'browser base64 to jpeg decoder',
    ],
    searchVolume: 4200,
    label: '',
  },
